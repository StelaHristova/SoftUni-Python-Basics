...
print(f'Total tickets: {total_count_ticket}')
percent_student = student_count / total_count_ticket * 100
percent_standard = standard_count / total_count_ticket * 100
percent_kids = kids_count / total_count_ticket * 100
